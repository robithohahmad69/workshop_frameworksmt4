...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header { background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); color: white; padding: 20px; }
        .header h1 { font-size: 20px; max-width: 600px; margin: 0 auto; }
        .container { max-width: 600px; margin: 28px auto; padding: 0 20px 40px; }
        .btn-back { display: inline-block; margin-bottom: 16px; color: #38a169; text-decoration: none; font-size: 13px; font-weight: bold; }
        ...
        input[type=text]:focus, select:focus { border-color: #38f9d7; }
...
<body>
    <div class="header">
        <h1>🖼️ Tambah Customer 2 — Simpan Foto sebagai File</h1>
    </div>
        ...
        <div class="modal" style="background: white; border-radius: 12px; padding: 20px; width: 92%; max-width: 660px;">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; padding-top: 12px; border-top: 1px solid #eee;">
                ...
                <div style="display: flex; gap: 8px;">
                    ...
                    <button onclick="gunakanFoto()" style="padding: 8px 14px; background: linear-gradient(135deg, #43e97b, #38f9d7); color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: bold;">✅ Simpan Foto</button>
                </div>
            </div>
        </div>
    </div>
